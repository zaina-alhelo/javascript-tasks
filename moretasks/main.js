...
// collection[0].innerHTML = "zaina";
document.getElementById("vv").innerHTML = "hello";

document.querySelector(".ff").style.backgroundColor = "red";
document.getElementsByClassName("ff");
collection[0].innerHTML = "Hello World!";
// document.getElementsByClassName("ff").innerHTML = "Hello World!";
